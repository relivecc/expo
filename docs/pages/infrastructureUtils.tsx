import { entries, keys, size, values } from 'lodash';
...
} = resourceSpecs.data as ResourceSpecData;
...
type HardwareListProps = { platform: Platform };
type BuildResourceListProps = { platform: Platform };
